  ...
  const handleAskFlorence = async () => {
    ...
    try {
      ...
      setGoals(prev => {
        ...
        const newGoalItems = newGoals.filter(goal => !existingIds.has(goal.id));
    ...
    <Card className={cn("rounded-florence overflow-hidden card-glow", className)}>
      <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border-b">
        ...
        <div className="grid grid-cols-4 gap-4 mb-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">{earnedRewards}</div>
            <div className="text-xs text-muted-foreground">HAIC Earned</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600">{totalRewards}</div>
