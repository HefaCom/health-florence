      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold">
            Health Profile<span className="text-primary">.</span>
          </h1>
          <p className="text-muted-foreground">
            Manage your health information, conditions, and medical history
          </p>
        </div>
          ...
          <div className="lg:col-span-1">
            <Card className="p-4 rounded-florence text-center card-glow">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Chat with Florence about your health profile
              </p>
